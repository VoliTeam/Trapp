...
<body>
    ...
    if(!isset($_POST['corregir'])){ //si no hemos clickado corregir
        ...
        for($i = 0; $i<$preguntasTotales; $i++){ //Asignamos las preguntas, respuestas y la rverdadera que hemos separado
    ...
    function obtenerDatos(){
      //Hay que traspasar aqui el codigo para obtener los datos. Está duplicado.
    }
